...
# ─────────────────────────────────────────────
# 2. 행정구역 좌표 데이터 안전하게 로드
# ─────────────────────────────────────────────
# 파이썬 문법 에러(SyntaxError)를 원천 차단하기 위해 딕셔너리를 안전한 구조로 정의합니다.
REGIONS = {
    ...
    "안산": (157, 262, 48, 42), "시흥": (162, 240, 40, 35), "의왕": (202, 270, 38, 30),
    "군포": (197, 278, 38, 30), "과천": (218, 262, 35, 28), "오산": (204, 310, 42, 35),
    "춘천": (380, 157, 75, 65), "홍천": (440, 184, 85, 70), "원주": (370, 247, 65, 55),
    "횡성": (422, 234, 58, 48), "평창": (472, 220, 72, 58), "강릉": (552, 187, 65, 52),
    "동해": (572, 234, 52, 45), "삼척": (580, 263, 58, 52), "태백": (540, 250, 4
